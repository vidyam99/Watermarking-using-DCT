...
print("                                                                                ")
print("Dimension of the host image martix: ",tup1)
image1_size = tup1[0]*tup1[1]*tup1[2]
print("Size of the host image matrix:", image1_size)
print("                                                                                ")
print("                                                                                ")
image2 = Image.open("watermark.jpeg")
# image2.show(title="Copyright Image")
...
print("                                                                                ")
print("Dimension of the copyright image matrix:", tup2)
#image size   
image2_size = tup2[0]*tup2[1]*tup2[2]

print("Size of the copyright image matrix: ",image2_size)
print("                                                                                ")
print("                                                                                ")
...
# print(dct( image1_array, axis=0, norm='ortho' )[0:1])
# print(image1_dct[0:1])
...
#q.save('temp.jpeg', quality=120)
# q.show('Embedded_image.jpeg')
...
print("PSNR of the cover and watermarked is: ",psnr)
print("                                                                                ")
print("                                                                                ")
#nsq = Image.open("temp.jpeg")
#out = np.asarray(nsq)
...
print("                                                                                ")
print("                                                                                ")
print("On average we are changing the pixel by not more than ", max1, " gray levels: ")
#***************************************************************************************
print("                                                                                ")
print("                                                                                ")
...
print("                                                                                ")
#**************************************************************************************
print("Shape of what is: ",what1.shape)
print("Shape of what is: ",wx.shape)
cos_sim = np.dot(what1,wx)/(LA.norm(what1)*LA.norm(wx))
print("Cosine similarity of the extracted and original copyright: ",cos_sim)
#*************************************************************************************
print("                                                                                ")
print("                                                                                ")
print("**********************************************************************************************************")
